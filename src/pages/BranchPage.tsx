...
const BRANCH_PRESENTATION: Record<CenterId, BranchPresentation> = {
  ...
  'nha-trang': {
    ...
    reviewSubtitle: '첫 체험다이빙, 가족 동행, 펀다이빙+체험다이빙 동행 후기를 중심으로 정리했습니다.',
    reviewHighlights: [
      { label: '후기 평점', value: '5.0' },
      { label: '주요 만족', value: '친절한 강사' },
      { label: '동행 장점', value: '펀+체험 가능' },
      { label: '포함사항', value: '픽드랍·점심' },
    ],
    reviewMeta: [
      {
        nickname: 'whtj******',
        ...
        product: '보트 체험다이빙 2회',
        groupType: '첫 체험다이빙',
        highlight: '이퀄라이징이 어려웠지만 끝까지 도와줘 성공했다는 후기',
      },
      {
        nickname: 'beho******',
        ...
        product: '보트 체험다이빙 2회',
        groupType: '체험 다이버',
        highlight: '처음부터 끝까지 안전하게 진행되어 다시 하고 싶다는 후기',
      },
      {
        nickname: 'family****',
        visitedAt: '2026.08 방문',
        product: '보트 체험다이빙 2회',
        groupType: '가족 여행',
        highlight: '11살 자녀도 무서워하지 않고 함께 즐겼다는 후기',
      },
      {
        nickname: 'skye****',
        visitedAt: '2026.06 방문',
        product: '보트 체험다이빙 2회',
        groupType: '재구매 고객',
        highlight: '상세한 교육과 긴 다이빙 시간에 만족했다는 후기',
      },
      {
        nickname: 'emer********',
        visitedAt: '2026.07 방문',
        product: '보트 체험다이빙 2회',
        groupType: '커플 여행',
        highlight: '물을 무서워하던 동행자가 첫 다이빙에 성공했다는 후기',
      },
      {
        nickname: 'jo33******',
        visitedAt: '2026.06 방문',
        product: '보트 체험다이빙 2회',
        groupType: '동행 다이빙',
        highlight: '펀다이빙과 체험다이빙을 함께 진행해 좋았다는 후기',
      },
    ],
  },
  bali: {
